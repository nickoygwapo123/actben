 ...
 * @author User
 */
public class BenFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BenFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
